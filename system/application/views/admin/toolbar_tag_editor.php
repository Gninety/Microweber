...
<div class="mw_admin_box_padding">
  ...
  <div id="mw_html_css_editor">
    ...
    <h3 class="css_editor_tab_size"><a href="#"><img  src="<?php   print( ADMIN_STATIC_FILES_URL);  ?>img/css_editor/border.png"  class="css_editor_accordeon_icon" />Border</a></h3>
    <div>
      <div class="mw_tag_editor_item_holder">
        <table border="0" cellspacing="5" cellpadding="0" >
          <tr valign="middle">
    ...
    <h3 class="css_editor_tab_size"><a href="#"><img  src="<?php   print( ADMIN_STATIC_FILES_URL);  ?>img/css_editor/background.png"  class="css_editor_accordeon_icon" />Background</a></h3>
    <div>
      <div class="mw_tag_editor_item_holder">
        <table border="0" cellspacing="5" cellpadding="0" >
          <tr valign="middle">
      ...
      <div class="mw_tag_editor_item_holder">
        <table border="0" cellspacing="5" cellpadding="0" >
           ...
           <tr valign="middle">
            ...
            <td> 
            <input  class="css_property mw_tag_editor_input mw_tag_editor_input_wide"  name="background-image"     />
              </td>
           ...
           <tr valign="middle">
            ...
            <td> 
            <select class="css_property mw_tag_editor_input mw_tag_editor_input_wide" name="background-repeat">
              <option value="">Default</option>
           ...
           <tr valign="middle">
            ...
            <td>
            <select class="css_property mw_tag_editor_input mw_tag_editor_input_wide" name="background-attachment">
              <option value="">Default</option>
           ...
           <tr valign="middle">
            ...
            <td> 
           <select class="css_property mw_tag_editor_input mw_tag_editor_input_wide" name="background-position">
              <option value="">Default</option>
